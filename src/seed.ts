export const libraryItemsSeed = [
    ...
    },
    {
        ...
        description: "For twelve long years, the dread fortress of Azkaban held an infamous prisoner named Sirius Black. Convicted of killing thirteen people with a single curse, he was said to be the heir apparent to the Dark Lord, Voldemort. Now he has escaped, leaving only two clues as to where he might be headed: Harry Potter's defeat of You-Know-Who was Black's downfall as well. And the Azkban guards heard Black muttering in his sleep, 'He's at Hogwarts...he's at Hogwarts.'",
        type: "book",
    },
    {
    ...
    },
    {
        ...
        description: "The brilliant, breathtaking conclusion to J.K. Rowling's Harry Potter series. Harry searches for the Horcruxes in a desparate attempt to defeat Lord Voldemort.",
        type: "book",
    },
    {
        title: "Harry Potter and the Sorcerer's Stone",
